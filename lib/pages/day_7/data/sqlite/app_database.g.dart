...
class ProductData extends DataClass implements Insertable<ProductData> {
  ...
  final String? name;
  final double? price;
  const ProductData({required this.id, this.name, this.price});
  @override
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> name = const Value.absent(),
                Value<double?> price = const Value.absent(),
              }) => ProductCompanion(id: id, name: name, price: price),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String?> name = const Value.absent(),
                Value<double?> price = const Value.absent(),
              }) => ProductCompanion.insert(id: id, name: name, price: price),
          withReferenceMapper:
              (p0) =>
                  p0
                      .map(

...
class ListViewSparatedScreen extends StatefulWidget {
  const ListViewSparatedScreen({super.key});

  @override
  State<ListViewSparatedScreen> createState() => _ListViewSparatedScreenState();
}

class _ListViewSparatedScreenState extends State<ListViewSparatedScreen> {
